const dataDoEvento = new Date("Mar 26, 2025  20:00:00");
...
const contaAsHoras = setInterval(function(){
    ...
    document.getElementById('contador').innerHTML = `O evento se encerra em ${diasAteOEvento}d ${horasAteOEvento}h ${minutosAteOEvento}m ${segundosAteOEvento}s`;
